<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enquiries.aspx.cs" Inherits="WebApplication3.enquiries" %>
...
<div class="container">
    <form action="enquiries.aspx" method="post" id="enquiries" runat="server">
        ...
        <div class="field">
            ...
            <textarea id="myEnquiry" runat="server" name="myEnquiry" placeholder="Enter your enquiries" rows="6" class="mbr-text mbr-fonts-style display-7"></textarea>
            <small></small>
        </div>

        <div class="field">
        <div class="mbr-section-btn"><
            <asp:button runat="server" type="submit" class="btn btn-success display-4" id="btnSubmit" Text="Submit" OnClick="btnSubmit_Click"></asp:button>
       
            <asp:button runat="server" id="btnCheckEnquiry" type="submit" class="btn display-4" Text="Check on Enquiry" BackColor="#660066" ForeColor="White" OnClick="btnCheckEnquiry_Click"></asp:button>
        </div>
            <p></p>
            <p></p>
